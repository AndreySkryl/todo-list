...
public class TaskController {
	...
	public HttpStatus newTask(@RequestBody Task task) {
		try {
	...
	public HttpStatus newTasks(@RequestBody Collection<Task> tasks) {
		try {
	...
	public HttpStatus deleteTask(@RequestParam(Task.GUID_OF_TASK) String guidOfTask) {
		try {
	...
	public HttpStatus deleteTasks(@RequestBody Collection<String> guidesOfTask) {
		try {
